...
public class Auth extends PropertyFile {
	...
	protected void createFile() {
		...
		logWriter.println("# =================================================================================");
		logWriter.println("# JMTwitterBot Auth File. Deleting this file will generate a new one.");
		logWriter.println("# =================================================================================");
		logWriter.println();
		logWriter.println("# The bot needs to have access to its account so it has permission to tweet, like, retweet, and see direct messages.");
		...
		logWriter.println("# 3) Make sure the app has access to direct messages. Change the permission level if necessary.");
		logWriter.println("# 4) Generate access keys.");
